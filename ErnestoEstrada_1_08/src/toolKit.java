/** File Toolkit.java - a class with general tools, version 06, 2015-07-21
   ...
   This class is a "pure" class and does not have a main program
...
public class toolKit {
  ...
  */
   ...
   /** giveMeAnS
       ...
       Process    1. If the quantity = 1, set the return string to the emmpty string;
                  2. Otherwise, set the return string to an "s"
